...
public final class LifecycleRuleTransition {
    ...
    private LifecycleRuleTransition(Builder builder) {
    ...
    */
    ...
    public static class Builder {
        ...
        */
        ...
        private Builder(LifecycleRuleTransition from) {
        ...
        public LifecycleRuleTransition build() {
            return new LifecycleRuleTransition(this);
        }
    }
}