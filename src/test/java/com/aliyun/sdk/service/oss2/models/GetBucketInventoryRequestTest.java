...
public class GetBucketInventoryRequestTest {

    @Test
    public void testEmptyBuilder() {
        GetBucketInventoryRequest request = GetBucketInventoryRequest.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        // to builder
        GetBucketInventoryRequest copy = request.toBuilder().build();
    ...
    public void testToBuilderPreserveState() {
        GetBucketInventoryRequest original = GetBucketInventoryRequest.newBuilder()
                .bucket("test-bucket")
                .inventoryId("test-inventory")
                .build();

        GetBucketInventoryRequest copy = original.toBuilder().build();
