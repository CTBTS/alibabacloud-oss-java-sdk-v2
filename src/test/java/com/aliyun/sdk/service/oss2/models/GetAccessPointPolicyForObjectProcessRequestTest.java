...
public class GetAccessPointPolicyForObjectProcessRequestTest {

    @Test
    public void testEmptyBuilder() {
        GetAccessPointPolicyForObjectProcessRequest request = GetAccessPointPolicyForObjectProcessRequest.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        GetAccessPointPolicyForObjectProcessRequest copy = request.toBuilder().build();
    ...
    public void testToBuilderPreserveState() {
        GetAccessPointPolicyForObjectProcessRequest original = GetAccessPointPolicyForObjectProcessRequest.newBuilder()
                .bucket("test-bucket")
                .accessPointForObjectProcessName("fc-ap-02")
                .build();

        GetAccessPointPolicyForObjectProcessRequest copy = original.toBuilder().build();
