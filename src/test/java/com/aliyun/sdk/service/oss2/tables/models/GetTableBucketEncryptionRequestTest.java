...
public class GetTableBucketEncryptionRequestTest {

    @Test
    public void testEmptyBuilder() {
        GetTableBucketEncryptionRequest request = GetTableBucketEncryptionRequest.newBuilder().build();
    ...
    public void testToBuilderPreserveState() {
        GetTableBucketEncryptionRequest original = GetTableBucketEncryptionRequest.newBuilder()
        ...
        GetTableBucketEncryptionRequest copy = original.toBuilder().build();
    ...
    public void jsonBuilder() {
        ...
        assertThat(input.opName()).isEqualTo("GetTableBucketEncryption");

        // GET requests typically don't have body content
