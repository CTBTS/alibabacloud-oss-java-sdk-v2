...
public class GetVectorIndexRequestTest {

    @Test
    public void testEmptyBuilder() {
        GetVectorIndexRequest request = GetVectorIndexRequest.newBuilder().build();
    ...
    public void testToBuilderPreserveState() {
        ...
        GetVectorIndexRequest original = GetVectorIndexRequest.newBuilder()
                .bucket("testbucket")
    ...
    public void xmlBuilder() throws Exception {
        ...
        assertThat(input.opName()).isEqualTo("GetVectorIndex");
