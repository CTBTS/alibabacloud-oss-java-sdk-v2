...
public class ListUserDataRedundancyTransitionResultTest {

    @Test
    public void testEmptyBuilder() {
        ListUserDataRedundancyTransitionResult result = ListUserDataRedundancyTransitionResult.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        ListUserDataRedundancyTransitionResult result = ListUserDataRedundancyTransitionResult.newBuilder()
                .headers(headers)
    ...
    public void testToBuilderPreserveState() {
        ...
        ListUserDataRedundancyTransitionResult original = ListUserDataRedundancyTransitionResult.newBuilder()
                .headers(headers)
                .innerBody(listBucketDataRedundancyTransition)
                .build();

        ListUserDataRedundancyTransitionResult copy = original.toBuilder().build();
    ...
    public void testXmlBuilderWithEncoding() {
        ...
        OperationOutput output = OperationOutput.newBuilder()
                ...
                .build();
        ListUserDataRedundancyTransitionResult result = SerdeBucketRedundancyTransition.toListUserDataRedundancyTransition(output);
        ...
        java.util.List<BucketDataRedundancyTransition> transitions = result.listBucketDataRedundancyTransition().bucketDataRedundancyTransition();
        BucketDataRedundancyTransition first = transitions.get(0);
