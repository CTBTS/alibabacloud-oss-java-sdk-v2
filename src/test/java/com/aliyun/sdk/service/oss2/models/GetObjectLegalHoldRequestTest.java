...
public class GetObjectLegalHoldRequestTest {

    @Test
    public void testEmptyBuilder() {
        GetObjectLegalHoldRequest request = GetObjectLegalHoldRequest.newBuilder().build();
    ...
    public void testToBuilderPreserveState() {
        GetObjectLegalHoldRequest original = GetObjectLegalHoldRequest.newBuilder()
                .bucket("testbucket")
                .key("testobject")
                .versionId("original-version-id")
                .build();

        GetObjectLegalHoldRequest copy = original.toBuilder().build();
