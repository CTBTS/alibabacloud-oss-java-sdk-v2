...
public class PutTableBucketEncryptionRequestTest {

    @Test
    public void testEmptyBuilder() {
        PutTableBucketEncryptionRequest request = PutTableBucketEncryptionRequest.newBuilder().build();
    ...
    public void testToBuilderPreserveState() {
        ...
        PutTableBucketEncryptionRequest original = PutTableBucketEncryptionRequest.newBuilder()
        ...
        PutTableBucketEncryptionRequest copy = original.toBuilder().build();
        ...
        assertThat(copy.encryptionConfiguration().sseAlgorithm()).isEqualTo("AES256");
    ...
    public void jsonBuilder() {
        ...
        assertThat(input.opName()).isEqualTo("PutTableBucketEncryption");
