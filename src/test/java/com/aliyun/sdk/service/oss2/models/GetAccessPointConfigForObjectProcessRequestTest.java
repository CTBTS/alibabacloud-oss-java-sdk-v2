...
public class GetAccessPointConfigForObjectProcessRequestTest {

    @Test
    public void testEmptyBuilder() {
        GetAccessPointConfigForObjectProcessRequest request = GetAccessPointConfigForObjectProcessRequest.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        GetAccessPointConfigForObjectProcessRequest copy = request.toBuilder().build();
    ...
    public void testToBuilderPreserveState() {
        GetAccessPointConfigForObjectProcessRequest original = GetAccessPointConfigForObjectProcessRequest.newBuilder()
                .bucket("test-bucket")
                .accessPointForObjectProcessName("fc-ap-02")
                .build();

        GetAccessPointConfigForObjectProcessRequest copy = original.toBuilder().build();
