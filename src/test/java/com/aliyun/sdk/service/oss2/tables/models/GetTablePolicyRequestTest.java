...
public class GetTablePolicyRequestTest {

    @Test
    public void testEmptyBuilder() {
        GetTablePolicyRequest request = GetTablePolicyRequest.newBuilder().build();
    ...
    public void testToBuilderPreserveState() {
        GetTablePolicyRequest original = GetTablePolicyRequest.newBuilder()
        ...
        GetTablePolicyRequest copy = original.toBuilder().build();
    ...
    public void xmlBuilder() {
        ...
        assertThat(input.opName()).isEqualTo("GetTablePolicy");
