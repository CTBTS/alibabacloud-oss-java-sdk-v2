...
public class GetTableEncryptionRequestTest {

    @Test
    public void testEmptyBuilder() {
        GetTableEncryptionRequest request = GetTableEncryptionRequest.newBuilder().build();
    ...
    public void testToBuilderPreserveState() {
        GetTableEncryptionRequest original = GetTableEncryptionRequest.newBuilder()
        ...
        GetTableEncryptionRequest copy = original.toBuilder().build();
    ...
    public void xmlBuilder() {
        ...
        assertThat(input.opName()).isEqualTo("GetTableEncryption");
