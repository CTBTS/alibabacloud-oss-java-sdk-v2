...
public class DeleteBucketCorsResultTest {

    @Test
    public void testEmptyBuilder() {
        DeleteBucketCorsResult result = DeleteBucketCorsResult.newBuilder().build();
    ...
    public void testXmlParsing() throws Exception {
        ...
        DeleteBucketCorsResult result = DeleteBucketCorsResult.newBuilder()
                .innerBody(innerBody)
                .build();
