...
public class DeleteTablePolicyRequestTest {

    @Test
    public void testEmptyBuilder() {
        DeleteTablePolicyRequest request = DeleteTablePolicyRequest.newBuilder().build();
    ...
    public void testToBuilderPreserveState() {
        DeleteTablePolicyRequest original = DeleteTablePolicyRequest.newBuilder()
        ...
        DeleteTablePolicyRequest copy = original.toBuilder().build();
    ...
    public void xmlBuilder() {
        ...
        assertThat(input.opName()).isEqualTo("DeleteTablePolicy");
