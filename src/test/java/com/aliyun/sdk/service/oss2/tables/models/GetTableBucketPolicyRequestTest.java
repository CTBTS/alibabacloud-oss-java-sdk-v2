...
public class GetTableBucketPolicyRequestTest {

    @Test
    public void testEmptyBuilder() {
        GetTableBucketPolicyRequest request = GetTableBucketPolicyRequest.newBuilder().build();
    ...
    public void testToBuilderPreserveState() {
        GetTableBucketPolicyRequest original = GetTableBucketPolicyRequest.newBuilder()
        ...
        GetTableBucketPolicyRequest copy = original.toBuilder().build();
    ...
    public void jsonBuilder() {
        ...
        assertThat(input.opName()).isEqualTo("GetTableBucketPolicy");
