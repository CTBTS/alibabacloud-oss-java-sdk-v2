...
public class QueryVectorsAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncVectorsClient client = clientBuilder.build()) {
            ...
            CompletableFuture<QueryVectorsResult> future = client.queryVectorsAsync(requestBuilder.build());

            QueryVectorsResult result = future.get();
